package com.example.hackerlcandroidfarmework.view.listview.custom;
...
import com.example.hackerlcandroidfarmework.view.listview.custom.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener {
	...
	public void enableAutoFetchMore(boolean enable, int index) {
		if (enable) {
			...
			mFooterTextView.setText("点击获取更多新闻");
